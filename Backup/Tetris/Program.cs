	...
	class Program
	{
		...
		public static void LoadScores(ref string[] HighScoresArray)
		{
			try
			{
				...
				{
					Array.Resize<string>(ref HighScoresArray,HighScoresArray.Length+1);
		...
		public static void WindowGrowAndShrink(int Size)
		{
